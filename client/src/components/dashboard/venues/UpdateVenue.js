...
export default function UpdateVenue({ loggedInUser }) {
  ...
  useEffect(() => {
    const fetchVenueDetails = async () => {
      ...
      //extract serviceIds
      const selectedServiceIds = venueDetails.venueServices.map(
        (vs) => vs.serviceId
      );
        ...
        <Row>
          <Col md={8} className="mx-auto">
            ...
            <Form>
              {/* Venue Name */}
              <FormGroup>
                <Label for="venueName" className="create-form-text">
                  Venue Name
                </Label>
                <Input
                  required
              ...
              <FormGroup>
                <Label for="serviceMulti" className="create-form-text">
                  Select Services
                </Label>
                <Input
                  id="upd-venue-service-select"
                  multiple
                  name="serviceMulti"
                  type="select"
                  value={serviceIds}
              ...
              {/* Max Occupancy */}
              <FormGroup>
                <Label for="maxOcc" className="create-form-text">
                  Max Occupancy
                </Label>
                <Input
                  required
              ...
              {/* Address */}
              <FormGroup>
                <Label for="address" className="create-form-text">
                  Address
                </Label>
                <Input
                  required
              ...
              {/* Image URl */}
              <FormGroup>
                <Label for="imgUrl" className="create-form-text">
                  Image Url
                </Label>
                <Input
                  required
              ...
              {/* Contact Info */}
              <FormGroup>
                <Label for="contact" className="create-form-text">
                  Contact Info
                </Label>
                <Input
                  required
              ...
              <FormGroup className="text-center">
                ...
                <Button
                  className="btn btn-primary mt-3 create-event-submit-btn"
