...
export default function UpdateService({ loggedInUser }) {
  ...
  useEffect(() => {
    const fetchServiceDetails = async () => {
      ...
      //extract venueids
      const selectedVenueIds = serviceDetails.venueServices.map(
        (vs) => vs.venueId
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //to parse the actual error from the db
        ...
        <Row>
          <Col md={8} className="mx-auto">
            ...
            <Form>
              {/* Venue Name */}
              <FormGroup>
                <Label for="serviceName" className="create-form-text">
                  Service Name
                </Label>
                <Input
                  required
              ...
              <FormGroup>
                <Label for="venueMulti" className="create-form-text">
                  Select Venues
                </Label>
                <Input
                  id="venueMulti"
              ...
              <FormGroup>
                <Label for="price" className="create-form-text">
                  Price
                </Label>
                <Input
                  required
