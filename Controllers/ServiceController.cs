...
public class ServiceController : ControllerBase
{
    ...
    {
        return Ok(_dbContext.Services
        .Where(s => s.VenueServices.Any(vs => vs.VenueId == venueId) && s.IsActive == true)
        .Include(s => s.VenueServices)
            .ThenInclude(vs => vs.Venue)
        .Select(s => new ServiceDTO
        {
...
[HttpPut("deactivate/{id}")]
    ...
    {
        var serviceToDeactivate = _dbContext.Services.SingleOrDefault(s => s.Id == id);
        ...
        _dbContext.SaveChanges();
        return Ok("Service Deactivation Successful");
...
[HttpPut("activate/{id}")]
    ...
    {
        var serviceToActivate = _dbContext.Services.SingleOrDefault(s => s.Id == id);
        ...
        _dbContext.SaveChanges();
        return Ok("Service Activation Successful");
